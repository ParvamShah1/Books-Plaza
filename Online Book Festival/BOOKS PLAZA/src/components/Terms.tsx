...
const Terms: React.FC = () => {
  const lastUpdated = "04-02-2025 12:46:47";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-yellow-50 py-8 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8">
        ...
        <p className="text-sm text-gray-500 mb-6">Last updated on {lastUpdated}</p>

        <div className="space-y-6 text-gray-600">
          <p>
          Terms & Conditions
Last updated on 04-02-2025 12:46:47
These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
agreement by and between PRAVIN SAMJIBHAI SHAH, ( “Website Owner” or “we” or “us” or “our”)
