...
This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.booksplaza.in/ 'Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').

The Platform is owned by BOOKS PLAZA, a company incorporated under the Companies Act, 1956 with its registered office at 123 Book Street, Literary Lane, Readers City - 400001 ,India (hereinafter referred to as ?Platform Owner?, 'we', 'us', 'our')..
...
All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts.
